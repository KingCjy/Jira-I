package me.kingcjy.jira.web.filter;
...
public class HttpLoggingFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        try {
            ...
            logger.info("# API Remote Address: " + ip);
            logger.info("# API Method: " + httpServletRequest.getMethod());
            logger.info("# API Parameters: " + requestMap);
            logger.info("# API Body: " + bufferedRequest.getRequestBody());
            logger.info("#============================================================#");
        } catch (Throwable a) {
